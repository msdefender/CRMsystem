<div class="sidebar hidden sm:block w-0 sm:w-1/6 bg-gray-200 h-screen shadow fixed top-0 left-0 bottom-0 z-40 overflow-y-auto">
    <div class="mb-6 mt-20 px-6">
        ...
        <a href="{{ route('products.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <a href="{{ route('leads.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
         <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
        </svg>
        <span class="ml-2 text-sm font-semibold">Leads</span>
        </a>

        <a href="{{ route('customers.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
            <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/>
            <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
        </svg>
        <span class="ml-2 text-sm font-semibold">Customers</span>
        </a>

        <a href="{{ route('units.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <span class="ml-2 text-sm font-semibold">Untis</span>
        </a>
        
        <a href="{{ route('orders.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <a href="{{ route('agreements.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <span class="ml-2 text-sm font-semibold">Agreements</span>
        </a>

        <a href="{{ route('agreementsF.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
        <path d="M8 4a.5.5 0 0 1 .5.5V6H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V7H6a.5.5 0 0 1 0-1h1.5V4.5A.5.5 0 0 1 8 4z"/>
        </svg>
        <span class="ml-2 text-sm font-semibold">Agreement Fields</span>
        </a>

        <a href="{{ route('credit.index') }}" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <span class="ml-2 text-sm font-semibold">Credits</span>
        </a>
